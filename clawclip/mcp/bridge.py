"""MCP Bridge — adapts external MCP servers into ClawClip Skill objects."""
...
def _mcp_tool_to_definition(raw: dict) -> ToolDefinition:
    """Convert a raw MCP tool descriptor to a ClawClip ToolDefinition."""
...
class MCPSkillAdapter:
    """Implements the ClawClip Skill protocol, wrapping an entire MCP server.
...
def create_skill_from_server(
    ...
    """Factory: create a ClawClip Skill that wraps an MCP server.
