...
from clawclip.platforms.telegram.handlers import build_router
from clawclip.platforms.telegram.streamer import TelegramStreamer
...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def _build_markup(
        ...
        """Convert ClawClip ``ButtonAction`` rows to aiogram ``InlineKeyboardMarkup``."""
        if not buttons:
            return None
