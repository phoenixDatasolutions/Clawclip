"""ClawClip CLI entry point — clawclip run / setup / config / db."""
...
@click.group()
@click.version_option(package_name="clawclip")
def cli() -> None:
...
def run(config: str, log_level: str) -> None:
    """Start ClawClip with all enabled platforms and services."""
...
def setup(config_dir: str) -> None:
    ...
    from clawclip.setup_wizard.wizard import run_wizard
...
def main() -> None:
    """Entry point for the clawclip command."""
    cli()
