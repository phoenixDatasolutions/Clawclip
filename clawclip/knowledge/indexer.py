"""Document indexer for the ClawClip RAG Knowledge Base module.

Chunks raw documents, generates embeddings, and stores them in the configured
vector store.  Re-uses :class:`~clawclip.knowledge.loaders.file_loader` for
...
class DocumentIndexer:
    ...
    async def index_file(self, path: str, knowledge_base_id: str) -> int:
        ...
        int
            Number of chunks indexed.
        """
        from clawclip.knowledge.loaders.file_loader import load_file
    ...
    async def index_directory(self, path: str, knowledge_base_id: str) -> int:
        ...
        int
            Number of chunks indexed.
        """
        from clawclip.knowledge.loaders.file_loader import load_directory
    ...
    async def delete_documents(self, knowledge_base_id: str) -> None:
        ...
        .. note::
            For :class:`~clawclip.knowledge.vectorstore.InMemoryStore` and
            :class:`~clawclip.knowledge.vectorstore.ChromaDBStore` this uses
