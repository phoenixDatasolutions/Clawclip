...
from clawclip.dashboard.routes.agents import create_agents_router
from clawclip.dashboard.routes.analytics import create_analytics_router
from clawclip.dashboard.routes.auth import create_auth_router
from clawclip.dashboard.routes.conversations import create_conversations_router
from clawclip.dashboard.routes.settings import create_settings_router
from clawclip.dashboard.routes.skills import create_skills_router
from clawclip.dashboard.routes.system import create_system_router
from clawclip.dashboard.routes.users import create_users_router
...
def create_dashboard_app(nexus_app: Any = None) -> FastAPI:
    """Create and configure the ClawClip Dashboard FastAPI application.

    Args:
        nexus_app: The running ClawClip application instance (provides access
    ...
    """
    app = FastAPI(
        title="ClawClip Dashboard",
        version="1.0.0",
        description="Web dashboard for managing and monitoring the ClawClip platform.",
        docs_url="/api/docs",
        redoc_url="/api/redoc",
    ...
    async def ws_agents(websocket: WebSocket) -> None:
        ...
        from clawclip.dashboard.ws.live_agents import websocket_agents
    ...
    async def ws_logs(websocket: WebSocket) -> None:
        ...
        from clawclip.dashboard.ws.live_logs import websocket_logs
    ...
    async def ws_chat(websocket: WebSocket) -> None:
        ...
        from clawclip.dashboard.ws.live_chat import websocket_chat
    ...
    logger.info("ClawClip Dashboard application created")
    return app
