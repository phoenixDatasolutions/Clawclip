...
from clawclip.healing.detector import FailureType, detect_failure, should_retry
from clawclip.healing.strategies import (
    RetryStrategy,
    StrategyConfig,
...
class EscalationManager:
    ...
    async def execute_with_healing(
        ...
        Args:
            ...
            agent_engine: An :class:`~clawclip.agents.engine.AgentEngine` instance.
    ...
    async def _escalate_human(
        ...
        if self._event_bus is not None:
            try:
                from clawclip.core.events import ApprovalRequired
