...
class LiteLLMProvider(BaseLLMProvider):
        ...
        if self._litellm is None:
            try:
                ...
                raise ImportError(
                    ...
                    "Install with: pip install nexusai[litellm]"
                )
    ...
    def _convert_messages(
        ...
        """Convert NexusAI messages to the OpenAI-compatible format litellm expects."""
    ...
    def _convert_tools(tools: list[ToolDefinition]) -> list[dict[str, Any]]:
        """Convert NexusAI tool definitions to OpenAI function-calling format."""
        return [
            {
                "type": "function",
                "function": {
