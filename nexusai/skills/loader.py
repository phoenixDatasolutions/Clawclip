...
class SkillLoader:
    ...
    _BUILTIN_MODULES = [
        "nexusai.skills.builtin.shell",
        "nexusai.skills.builtin.git",
        "nexusai.skills.builtin.files",
        "nexusai.skills.builtin.monitor",
        "nexusai.skills.builtin.screenshot",
        "nexusai.skills.builtin.web_search",
        "nexusai.skills.builtin.services",
    ]

    _DEVELOPER_MODULES = [
        "nexusai.skills.developer.code_review",
        "nexusai.skills.developer.pr_management",
        "nexusai.skills.developer.ci_cd",
        "nexusai.skills.developer.deployment",
    ...
    def load_from_directory(self, path: str) -> list[Any]:
        ...
        for py_file in sorted(dir_path.glob("*.py")):
            if py_file.name.startswith("_"):
                continue
            module_name = f"_nexusai_dynamic.{py_file.stem}"
