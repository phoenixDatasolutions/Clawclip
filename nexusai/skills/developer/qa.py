...
class QASkill:
            ...
            ToolDefinition(
                ...
                parameters={
                    ...
                    "properties": {
                        ...
                        "coverage": {
                            "type": "boolean",
                            "description": "Collect coverage for nexusai package",
                            "default": False,
                        },
                        "fail_fast": {
                            "type": "boolean",
    ...
    async def _run_tests(self, args: dict[str, Any], cwd: str) -> SkillResult:
        ...
        if args.get("coverage"):
            cmd += ["--cov=nexusai", "--cov-report=term-missing"]
        cmd += ["--tb=short", "-q"]
    ...
    async def _get_test_coverage(self, args: dict[str, Any], cwd: str) -> SkillResult:
        module = args.get("module", "nexusai")
    ...
    def _check_imports(self, args: dict[str, Any]) -> SkillResult:
        package = args.get("package", "nexusai")
        failures: list[str] = []
        try:
