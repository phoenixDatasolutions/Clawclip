"""NexusAI Webhooks — route incoming webhook events to actions."""
...
from nexusai.webhooks.templates.generic import parse_generic_webhook
from nexusai.webhooks.templates.github import parse_github_webhook
from nexusai.webhooks.templates.gitlab import parse_gitlab_webhook
...
class WebhookRouter:
    ...
    async def _execute_action(self, route: WebhookRoute, event: dict) -> Any:
        ...
        if action == "agent_task":
            ...
            from nexusai.core.types import TaskRequest
