"""NexusAI Webhooks — FastAPI gateway for receiving and managing webhooks."""
...
from nexusai.webhooks.router import WebhookRoute, WebhookRouter
...
class WebhookGateway:
    """FastAPI router factory for the NexusAI webhook gateway.
        ...
        async def receive_webhook(webhook_id: str, request: Request) -> JSONResponse:
            ...
            if self._secret:
                sig_header = (
                    ...
                    or request.headers.get("X-NexusAI-Signature")
                    or ""
                )
