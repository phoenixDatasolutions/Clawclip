...
from nexusai.workflows.parser import parse_workflow_file, validate_workflow
from nexusai.workflows.steps import WorkflowStepDef, execute_step
...
class WorkflowEngine:
    ...
    def _setup_trigger(self, wf: WorkflowDefinition) -> None:
        ...
        from nexusai.core.enums import TriggerType  # noqa: PLC0415
