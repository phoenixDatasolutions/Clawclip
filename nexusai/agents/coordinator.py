...
COORDINATOR_SYSTEM_PROMPT = """You are the Coordinator Agent for NexusAI, a multi-agent AI platform.
    ...
    async def _execute_delegation(
        ...
        for subtask_def in subtasks:
            ...
            try:
                ...
                from nexusai.agents.base_agent import BaseAgent as SubAgent
