...
_PLANNER_SYSTEM_PROMPT = """You are a task planning assistant for NexusAI, a multi-agent AI platform.
...
class TaskPlanner:
    ...
    async def plan(
        ...
        from nexusai.core.types import LLMMessage
    ...
    async def execute_plan(
        ...
        Args:
            ...
            engine: An :class:`~nexusai.agents.engine.AgentEngine` instance.
