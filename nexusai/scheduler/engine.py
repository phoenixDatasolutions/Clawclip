"""NexusAI Scheduler — APScheduler-based async execution engine."""
...
from nexusai.scheduler.jobs import JobType, ScheduledJob
...
class SchedulerEngine:
    """Wraps APScheduler's AsyncIOScheduler with NexusAI job management.
