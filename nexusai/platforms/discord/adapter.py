...
from nexusai.platforms.discord.formatter import DiscordFormatter
...
class DiscordAdapter(BasePlatformAdapter):
    ...
    Args:
        ...
        event_bus:      NexusAI event bus for publishing incoming events.
    ...
    async def send_message(
        ...
        if message.buttons:
            from nexusai.platforms.discord.views import ButtonView
