...
(which route into the NexusAI core), rather than importing core modules
...
from nexusai.platforms.telegram.keyboards import (
    main_menu_keyboard,
...
def build_router(adapter: TelegramAdapter) -> Router:
    ...
    def _to_incoming(message: Message, text_override: str | None = None) -> IncomingMessage:
        """Convert an aiogram ``Message`` to a NexusAI ``IncomingMessage``."""
