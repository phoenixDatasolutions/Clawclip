"""NexusAI Interactive Setup Wizard — guided terminal experience."""
...
def run_wizard(config_dir: str = "config") -> None:
    ...
    console.print(
        Panel.fit(
            "[bold cyan]NexusAI Setup Wizard[/bold cyan]\n\n"
            "This wizard will help you configure NexusAI.\n"
...
def _save_config(config: dict, config_path: Path) -> None:
    ...
    env_file = Path(".env")
    env_lines = ["# Auto-generated by NexusAI setup wizard", ""]
...
def _step_summary(
    ...
    console.print(
        Panel.fit(
            ...
            "Start NexusAI:\n"
            "  [cyan]nexusai run[/cyan]\n"
            "  — or —\n"
            "  [cyan]make run[/cyan]\n\n"
            "Change settings anytime:\n"
            "  [cyan]nexusai setup[/cyan]  (CLI wizard)\n"
