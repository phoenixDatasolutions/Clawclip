...
from nexusai.branching.diff import diff_branches
from nexusai.branching.storage import BranchStore, ConversationBranch
...
class BranchManager:
    ...
    *db_session_factory* (async SQLAlchemy session factory) to access the
    ...
    async def merge_branch(self, branch_id: str, target_conv_id: str) -> None:
        ...
        try:
            from nexusai.storage.models.conversation import ConversationMessage
