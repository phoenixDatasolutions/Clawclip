...
from nexusai.healing.detector import FailureType
from nexusai.healing.strategies import RetryStrategy
...
class FeedbackStore:
    ...
    Allows :class:`~nexusai.healing.escalation.EscalationManager` to prefer
